...
const STEPS: Step[] = [
  {
    ...
    light: { bg: "#eef2ff", color: "#1e1b4b", accent: "#4f46e5" },
  },
  {
    ...
    light: { bg: "#faf5ff", color: "#3b0764", accent: "#9333ea" },
  },
  {
    ...
    light: { bg: "#eff6ff", color: "#1e3a8a", accent: "#2563eb" },
  },
  {
    ...
    light: { bg: "#f0fdf4", color: "#14532d", accent: "#16a34a" },
  },
  {
    ...
    light: { bg: "#fffbeb", color: "#78350f", accent: "#d97706" },
    isCta: true,
  },
];
